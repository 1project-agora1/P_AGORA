        ...
        >
            ...
            >
                <div className="icon-text-container">
                    ...
                    <span className="text">중간 정렬</span>
                </div>
            </DropDownItem>
            <DropDownItem
                onClick={() => {
            ...
            >
                <div className="icon-text-container">
                    ...
                    <span className="text">바깥쪽 들여쓰기</span>
                </div>
            </DropDownItem>
            <DropDownItem
                onClick={() => {
            ...
            >
                <div className="icon-text-container">
                    ...
                    <span className="text">안쪽 들여쓰기</span>
                </div>
            </DropDownItem>
        </DropDown>
    );
                ...
                <>
                    ...
                    >
                        ...
                        <DropDownItem
                            ...
                            className={
                                "item wide " +
                                dropDownActiveClass(toolbarState.isHighlight)
                            }
                            title="Highlight"
                        ...
                        >
                            <div className="icon-text-container">
                                ...
                                <span className="text">문자 스타일 제거</span>
                            </div>
                        </DropDownItem>
                    </DropDown>
                    {canViewerSeeInsertDropdown && (
                        <>
                            ...
                            >
                                ...
                                >
                                    <i className="icon image" />
                                    <span className="text">인라인 이미지</span>
                                </DropDownItem>
                                {/* <DropDownItem
                                    onClick={() => {
                                        showModal(
